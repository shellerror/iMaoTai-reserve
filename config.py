...
SCKEY = os.environ.get('SCKEY') or "SCT313052TNYN1tqf7f3LPiql1ZCAkLEOl"
...
'''
AMAP_KEY = os.environ.get("GAODE_KEY") or "03ceb0e2c1fca9eeea071de8e6e009be"
...
'''
PRIVATE_AES_KEY = os.environ.get("PRIVATE_AES_KEY") or "imt_secret_key_2024_beijing"
